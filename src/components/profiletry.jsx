  ...
  return (
    <div>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <h1 style={{ marginTop: '60px' }}>List of Profiles</h1>
      </div>
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={handleBackToList}></button>
              </div>
              <div className="modal-body">
          <>
      <p><span style={{ fontWeight: 'bold'}}>ID:</span><br />{selectedProfile.id}</p>
      <p><span style={{ fontWeight: 'bold'}}>Title:</span><br />{selectedProfile.title}</p>
      <p><span style={{ fontWeight: 'bold'}}>Body:</span><br />{selectedProfile.body}</p>
    </>

              </div>
              <div className="modal-footer">
                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={handleBackToList}>Close</button>
              </div>
            </div>
          </div>
        </div>
