      ...
      <div className="container-fluid">
        ...
        <ul className="navbar-nav me-auto">
          <li className="nav-item">
            <Link className="nav-link my-2 my-sm-0" to="/profile">Home</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link my-2 my-sm-0" to="/addprofile">Add Profile</Link>
          </li>
        </ul>
        <button className="btn btn-primary" onClick={handleLogout}>Logout <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
