...
function ProfileTable() {
    ...
    useEffect(() => {
        if (searchQuery.trim() === "") {
            ...
            // Filter data based on the selected search option
            let filtered = [];
            if (searchBy === "name") {
                filtered = data.filter((post) =>
                    post.name && post.name.toLowerCase().includes(searchQuery.toLowerCase())
                );
            } else if (searchBy === "pop_name") {
                filtered = data.filter((post) =>
                    post.pop_name && post.pop_name.toLowerCase().includes(searchQuery.toLowerCase())
                );
            } else if (searchBy === "dslam_hostname") {
                filtered = data.filter((post) =>
                    post.dslam_hostname &&
                    post.dslam_hostname.toLowerCase().includes(searchQuery.toLowerCase())
                );
            }
            setFilteredData(filtered);
        }
    }, [data, searchQuery, searchBy]);
            ...
            <div className="search-container">
                ...
                <div className="radio-buttons">
                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                        ...
                        <label class="btn btn-outline-primary" for="name">Search by Name</label>
                        ...
                        <input
                            ...
                            name="searchBy"
                            id="pop_name"
                            checked={searchBy === "pop_name"}
                            onChange={() => setSearchBy("pop_name")}
                        />

                        <label class="btn btn-outline-primary" for="pop_name">pop_name</label>
                        ...
                        <input
                            ...
                            id="dslam_hostname"
                            checked={searchBy === "dslam_hostname"}
                            onChange={() => setSearchBy("dslam_hostname")}
                        />

                        <label class="btn btn-outline-primary" for="dslam_hostname">dslam_hostname</label>
                    </div>
                </div>
            </div>
